...
function sms_to_wordpress($sms)
{
	...
	if (strtoupper($code)===strtoupper($wordpress_code))
	{
		...
		require_once APPPATH.'../vendor/kissifrot/php-ixr/src/Client/Client.php';
		require_once APPPATH.'../vendor/kissifrot/php-ixr/src/Message/Error.php';
		require_once APPPATH.'../vendor/kissifrot/php-ixr/src/Message/Message.php';
		require_once APPPATH.'../vendor/kissifrot/php-ixr/src/Request/Request.php';
		require_once APPPATH.'../vendor/kissifrot/php-ixr/src/DataType/Value.php';
